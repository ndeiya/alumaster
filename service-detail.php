...
<section class="section" style="background: white; padding: 80px 0;">
    <div class="container">
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 64px; align-items: start; max-width: 1400px; margin: 0 auto;">
            <!-- Main Content -->
            <div class="service-detail-main">
                <!-- Service Description -->
                <div style="margin-bottom: 48px;">
                    <h2 style="font-size: 2rem; font-weight: 700; color: #1a202c; margin-bottom: 24px; border-bottom: 3px solid #3b82f6; padding-bottom: 12px; display: block; width: fit-content;">
                        Service Overview
                    </h2>
                ...
                <div style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05); border: 1px solid #e2e8f0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 20px; padding: 16px; background: #f8fafc; border-radius: 12px;">
                        ...
                        <div>
                            ...
                            <a href="mailto:contact@alumastergh.com" style="color: #1a202c; text-decoration: none; font-weight: 600;">contact@alumastergh.com</a>
                        </div>
                    </div>
...
@media (max-width: 768px) {
    ...
    /* Key Benefits Grid - single column */
    ...
    section[style*="grid"] div[style*="grid-template-columns"] {
        grid-template-columns: 1fr !important;
    }
}
