    ...
    if (!validate_csrf_token($_POST['csrf_token'])) {
        ...
        if (empty($errors)) {
            try {
                ...
                log_admin_activity('create', "Created service: $name", $service_id);
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Create a new service offering</p>
    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="short_description" name="short_description" class="form-textarea" rows="3" required 
                              placeholder="Brief description for service listings..."><?php echo htmlspecialchars($_POST['short_description'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-textarea" rows="8" required 
                              placeholder="Detailed service description..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="technical_specs" name="technical_specs" class="form-textarea" rows="6" 
                              placeholder="Technical specifications, features, materials, etc..."><?php echo htmlspecialchars($_POST['technical_specs'] ?? ''); ?></textarea>
                </div>
            </div>
