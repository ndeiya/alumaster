        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-menu">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle <?php echo strpos($_SERVER['PHP_SELF'], '/projects/') !== false ? 'active' : ''; ?>">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul class="nav-dropdown-menu">
                            <li><a href="<?php echo $base_path; ?>projects/list.php" class="nav-dropdown-link">All Projects</a></li>
                            <li><a href="<?php echo $base_path; ?>projects/add.php" class="nav-dropdown-link">Add Project</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $base_path; ?>spam-monitor.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) === 'spam-monitor.php' ? 'active' : ''; ?>">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="nav-text">Spam Monitor</span>
                        </a>
                    </li>
