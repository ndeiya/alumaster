...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($section_key && $content) {
        try {
            ...
            $stmt = $pdo->prepare("UPDATE page_sections SET content = ?, settings = ?, is_active = ? WHERE page_slug = 'about' AND section_key = ?");
            $stmt->execute([$content, $settings, $is_active, $section_key]);
            
            $success_message = "About page section updated successfully!";
...
try {
    ...
    $stmt = $pdo->query("SELECT * FROM page_sections WHERE page_slug = 'about' ORDER BY sort_order ASC");
...
<div class="admin-content">
    <div class="content-header">
        ...
        <p>Manage your About page content sections</p>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (sectionKey === 'hero') {
                const content = {
                    ...
                    description: form.querySelector('textarea[name="hero_description"]').value
                };
