...
try {
    ...
    // Get parent pages for dropdown (excluding current page and its children)
    $stmt = $conn->prepare("SELECT id, title FROM pages WHERE id != ? AND parent_id IS NULL ORDER BY title");
    $stmt->execute([$page_id]);
...
if ($_POST && isset($_POST['update_page'])) {
        ...
        if (empty($errors)) {
            try {
                $stmt = $conn->prepare("UPDATE pages SET 
                                       ...
                                       status = ?, sort_order = ?, show_in_nav = ?, parent_id = ?, 
                ...
                $stmt->execute([
                    ...
                    $sort_order, $show_in_nav, $parent_id, $page_id
                ]);
                
                log_admin_activity('update', "Updated page: $title", $page_id);
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Update page content and settings</p>
    </div>
    <div class="page-header-actions">
        ...
        <a href="../../<?php echo $page_data['slug']; ?>.php" target="_blank" class="btn btn-outline">
            <svg class="icon-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-select">
                            ...
                            <option value="private" <?php echo $page_data['status'] === 'private' ? 'selected' : ''; ?>>Private</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="template" name="template" class="form-select">
                            <option value="default" <?php echo $page_data['template'] === 'default' ? 'selected' : ''; ?>>Default</option>
                            <option value="full-width" <?php echo $page_data['template'] === 'full-width' ? 'selected' : ''; ?>>Full Width</option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="excerpt" name="excerpt" class="form-textarea" rows="3" 
                              placeholder="Brief description of the page..."><?php echo htmlspecialchars($page_data['excerpt']); ?></textarea>
                </div>
            </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-input" 
                               value="<?php echo $page_data['sort_order']; ?>" min="0">
                ...
                <div class="form-group">
                    <div class="form-checkbox">
                        <input type="checkbox" id="show_in_nav" name="show_in_nav" value="1" 
                               <?php echo $page_data['show_in_nav'] ? 'checked' : ''; ?>>
                        <label for="show_in_nav" class="checkbox-label">Show in Navigation</label>
                    </div>
                </div>
                
                <?php if ($page_data['is_homepage']): ?>
                <div class="form-group">
                    <div class="homepage-notice">
                        <svg class="icon-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        This is your homepage. Some settings may be restricted.
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="meta_description" name="meta_description" class="form-textarea" rows="3" 
                              placeholder="SEO description for search engines..."><?php echo htmlspecialchars($page_data['meta_description']); ?></textarea>
                </div>
